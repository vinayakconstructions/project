    ...
    <div className="min-h-screen bg-gray-100 text-gray-900">
      <div className="max-w-6xl mx-auto p-6 text-center">
        ...
        >
          ...
          We are committed to protecting your privacy at Vinayak Constructions Company. We do not collect any personal information that you do not voluntarily provide, and we are the sole owners of all information collected on this site. We do not sell, share, or rent this information in any way that is not mentioned in this statement.<br></br><br></br>

          <b>Third Parties</b><br></br><br></br>
          Vinayak Constructions Company may share aggregated statistical data about our customers, website traffic, and related usage information with third parties. This data reflects site usage patterns but does not include behavioral or identifying details about any individual, unless explicitly permitted by the user.<br></br><br></br>
          Additionally, we may provide log files and other user-related data to third-party services for website traffic analysis to improve our content offerings. Vinayak Constructions Company may also work with third-party companies to deliver email newsletters and promotional messages.<br></br><br></br>
